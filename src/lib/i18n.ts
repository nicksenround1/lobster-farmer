...
export const translations = {
  zh: {
    ...
    hero: {
      ...
      description: "AI 研究者 · OpenClaw 深度用户 · AI Agent 构建者",
      cta: "加入社区",
      learnMore: "了解更多",
    },
    // About
    about: {
      title: "关于我",
      p1: "我是一名 AI 研究者、OpenClaw 深度用户、AI Agent 构建者。",
      p2: "我相信 AI Agent 是下一个生产力革命。通过 OpenClaw 平台，我构建了一套完整的 AI 自动化体系——从信息监控、数据分析到自动执行。",
      p3: "现在，我把这些能力开放给你。",
      highlight1: "6+",
  ...
  en: {
    ...
    hero: {
      ...
      description: "AI Researcher · OpenClaw Power User · AI Agent Builder",
      cta: "Join Community",
      learnMore: "Learn More",
    },
    about: {
      title: "About Me",
      p1: "I'm an AI researcher, OpenClaw power user, and AI agent builder.",
      p2: "I believe AI agents are the next productivity revolution. Through OpenClaw, I've built a complete AI automation system — from information monitoring and data analysis to automated execution.",
